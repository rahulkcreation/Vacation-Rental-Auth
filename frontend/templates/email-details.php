<?php
/**
 * AuthMe — Details Email Template
 *
 * Used for emails that include login credentials:
 *   - Host account approval (with generated username/password)
 *
 * Variables available:
 *   $authme_email_title    — Main heading text
 *   $authme_email_desc     — Body description text
 *   $authme_host_username  — Generated username
 *   $authme_host_password  — Generated password
                ...
                <table width="500" cellpadding="0" cellspacing="0" style="max-width:500px; width:96%; background-color:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 12px 30px rgba(0,0,0,0.05);">
                    ...
                    <tr>
                        <td style="padding:30px 14px; text-align:center;">
                            ...
                            <table width="90%" cellpadding="0" cellspacing="0" style="background-color:#FAFAFA; border-radius:16px; padding:16px 12px; border:1px dotted #e2e8f0; margin:0 auto;">
                                <!-- Username Row -->
                                <tr>
                                    <td style="padding:8px 12px; font-size:0.9rem; font-weight:600; color:#000000; text-align:left;">
                                        Username
                                    </td>
                                    <td style="padding:8px 12px; font-size:0.8rem; font-weight:400; color:#000000; text-align:right;">
                                        <?php echo esc_html( $authme_host_username ); ?>
                                    </td>
                                </tr>
                                <!-- Password Row -->
                                <tr>
                                    ...
                                    <td style="padding:8px 12px; font-size:0.8rem; font-weight:400; color:#000000; text-align:right;">
                                        <?php echo esc_html( $authme_host_password ); ?>
                                    </td>
                                </tr>
                            </table>

                            <!-- Note -->
                            <p style="width:90%; margin:30px auto 0 auto; color:#ea0124; font-size:0.85rem;">
